...
def removePunctuation(text):
    ...
    """
    return re.sub(r'[^0-9a-zA-Z\s]', '', text).strip().lower()
...
# TODO: Replace <FILL IN> with appropriate code
import re
shakespeareWordsRDD = shakespeareRDD.flatMap(lambda line: re.split('\s', line))
...
# TODO: Replace <FILL IN> with appropriate code
shakeWordsRDD = shakespeareWordsRDD.filter(lambda line: line != "").flatMap(lambda line: line.split())
